...
#grab he MNIST dataset
print("[INFO] accessing MNIST...")
dataset = datasets.fetch_mldata("MNIST Original")
data = dataset.data

#if we were using "channels first" ordering, then reshape the
...
H = model.fit(trainX, trainY, validation_data=(testX, testY), batch_size=128, epochs=epoch_num, verbose=1)
